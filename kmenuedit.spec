...
Source0  : https://download.kde.org/stable/plasma/6.3.4/kmenuedit-6.3.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.4/kmenuedit-6.3.4.tar.xz.sig
...
%setup -q -n kmenuedit-6.3.4
cd %{_builddir}/kmenuedit-6.3.4
pushd ..
cp -a kmenuedit-6.3.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744126724
mkdir -p clr-build
pushd clr-build
