...
Source0  : https://download.kde.org/stable/plasma/6.4.0/kmenuedit-6.4.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.4.0/kmenuedit-6.4.0.tar.xz.sig
...
%setup -q -n kmenuedit-6.4.0
cd %{_builddir}/kmenuedit-6.4.0
pushd ..
cp -a kmenuedit-6.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750182322
mkdir -p clr-build
pushd clr-build
