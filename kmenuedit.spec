...
Source0  : https://download.kde.org/stable/plasma/6.0.5/kmenuedit-6.0.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.5/kmenuedit-6.0.5.tar.xz.sig
...
%setup -q -n kmenuedit-6.0.5
cd %{_builddir}/kmenuedit-6.0.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716388669
mkdir -p clr-build
pushd clr-build
