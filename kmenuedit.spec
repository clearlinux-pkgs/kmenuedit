...
Version  : 6.2.5
Release  : 111
URL      : https://download.kde.org/stable/plasma/6.2.5/kmenuedit-6.2.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.2.5/kmenuedit-6.2.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.5/kmenuedit-6.2.5.tar.xz.sig
...
%setup -q -n kmenuedit-6.2.5
cd %{_builddir}/kmenuedit-6.2.5
pushd ..
cp -a kmenuedit-6.2.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736180468
mkdir -p clr-build
pushd clr-build
