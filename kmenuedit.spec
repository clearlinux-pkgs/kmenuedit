...
Version  : 5.14.4
Release  : 7
URL      : https://download.kde.org/stable/plasma/5.14.4/kmenuedit-5.14.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.14.4/kmenuedit-5.14.4.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.4/kmenuedit-5.14.4.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1543393210
mkdir -p clr-build
pushd clr-build
%cmake ..
