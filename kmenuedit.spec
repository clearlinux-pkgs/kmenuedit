...
Version  : 5.20.4
Release  : 45
URL      : https://download.kde.org/stable/plasma/5.20.4/kmenuedit-5.20.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.20.4/kmenuedit-5.20.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.20.4/kmenuedit-5.20.4.tar.xz.sig
...
%prep
%setup -q -n kmenuedit-5.20.4
cd %{_builddir}/kmenuedit-5.20.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1606839147
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kmenuedit-5.20.4/COPYING %{buildroot}/usr/share/package-licenses/kmenuedit/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/kmenuedit-5.20.4/COPYING.DOC %{buildroot}/usr/share/package-licenses/kmenuedit/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
pushd clr-build
%make_install
popd
%find_lang kmenuedit
