...
Source0  : https://download.kde.org/stable/plasma/5.14.0/kmenuedit-5.14.0.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.0/kmenuedit-5.14.0.tar.xz.sig
Summary  : No detailed summary available
Group    : Development/Tools
License  : GFDL-1.2 GPL-2.0
Requires: kmenuedit-bin
Requires: kmenuedit-data
Requires: kmenuedit-license
...
export LANG=C
export SOURCE_DATE_EPOCH=1539110820
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
cp COPYING.DOC %{buildroot}/usr/share/doc/kmenuedit/COPYING.DOC
pushd clr-build
%make_install
popd
%find_lang kmenuedit
...
%files license
%defattr(0644,root,root,0755)
/usr/share/doc/kmenuedit/COPYING
/usr/share/doc/kmenuedit/COPYING.DOC
