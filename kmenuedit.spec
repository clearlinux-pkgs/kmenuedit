...
Source0  : https://download.kde.org/stable/plasma/5.23.3/kmenuedit-5.23.3.tar.xz
...
%prep
%setup -q -n kmenuedit-5.23.3
cd %{_builddir}/kmenuedit-5.23.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636493636
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kmenuedit-5.23.3/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/kmenuedit/ee03d68f6be20b170e5ea5d114d6acafb3f2d1dc
cp %{_builddir}/kmenuedit-5.23.3/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kmenuedit/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/kmenuedit-5.23.3/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kmenuedit/e712eadfab0d2357c0f50f599ef35ee0d87534cb
pushd clr-build
%make_install
popd
%find_lang kmenuedit
